    ...
    <div className="overflow-x-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-14 pb-4">
        ...
        >
          ...
          {/* Blog — right column, spans both rows */}
          <Link
            to="/blog"
          ...
          {/* Products — bottom-right of left block */}
          <Link
            to="/products"
      ...
      {featuredContent.length > 0 && (
        <div className="mt-20 mx-auto max-w-7xl px-6">
          <div className="flex items-baseline justify-between mb-6">
            ...
            <Link to="/content" className="text-sm text-slate-500 hover:text-white transition-colors">
              View all →
            </Link>
          </div>
          <div
          ...
          >
            ...
            {/* Peek card to signal scrollability */}
            <Link
              to="/content"
      ...
      {featuredPosts.length > 0 && (
        <div className="mt-20 mx-auto max-w-7xl px-6 pb-24">
          <div className="flex items-baseline justify-between mb-6">
            ...
            <Link to="/blog" className="text-sm text-slate-500 hover:text-white transition-colors">
              View all →
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
            ...
            <div className="lg:col-span-2 flex flex-col gap-4">
              ...
              {/* If only 1 featured post exists, fill with a CTA */}
